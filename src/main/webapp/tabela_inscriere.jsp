...
<body>
	<div id="container">
		<h1>Tabela Inscrieri</h1>
		<p>
			<a href="nou_inscriere.jsp"><b>Adauga o noua inscriere</b></a>
		</p>
		<form action="stergere_inscriere.jsp" method="post"
